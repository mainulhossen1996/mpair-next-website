  ...
  return (
    <div className='seo-back pt-36'>
        <div className='max-w-screen-xl mx-auto'>
            <h1 className='text-[70px] font-thin text-center'>
            ...
            <div className='flex items-end gap-6 py-20'>
                <div className='border border-gray-800 card-back-bg w-4/12 rounded-2xl h-[450px] overflow-hidden'>
                    <div className='p-6'> 
                    <p className='text-[18px] font-thin text-white'>We specialize in connecting businesses to international markets, offering tailored strategies to <span className='font-semibold'>boost visibility, drive growth, and achieve global success.</span></p>
                    </div>
