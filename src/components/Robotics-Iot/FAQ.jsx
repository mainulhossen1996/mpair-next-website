...
const FAQ = () => {
  ...
  const faqs = [
    {
      question:
        "Do you handle both hardware and software development for IoT and Robotics?",
      answer:
    ...
    {
      question:
        "Do you provide training for using your Robotics & IoT systems?",
      answer:
    ...
    {
      question:
        "Do you provide AI-based automation in Robotics and IoT solutions?",
      answer:
        "Yes, we integrate AI to enhance decision-making, automation, and predictive analytics.",
    },
    {
      question:
        "Why should I choose you over other Robotics & IoT service providers?",
      answer:
        ...
        <div className="rounded-3xl">
          <div className="lg:flex gap-10">
            <div className="lg:w-4/12 mb-4 lg:mb-0">
              <p className="lg:text-[70px] text-[50px] font-semibold text-blue-600">
