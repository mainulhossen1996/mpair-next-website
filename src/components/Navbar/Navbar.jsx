...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
      className={`max-w-screen-xl mx-auto p-4 flex justify-between items-center relative rounded-full transition-all duration-300 ${
    ...
    >
          ...
          <div className="hidden md:flex gap-10">
            <div className="relative" ref={dropdownRef}>
              <div onClick={() => toggleDropdown('service')} className="font-medium cursor-pointer text-md text-gray-800 hover:text-[#008CFF]" aria-expanded={dropdownState.service}>
                Service
              </div>
            ...
            <div className="relative" ref={dropdownRefPro}>
              <div onClick={() => toggleDropdown('product')} className="font-medium cursor-pointer text-md text-gray-800 hover:text-[#008CFF]" aria-expanded={dropdownState.product}>
                Product
              </div>
            ...
            <Link href="/client" className={`font-medium hover:text-[#008CFF] text-md ${pathname === "/client" ? "text-[#008CFF]" : "text-gray-800"}`}>Work</Link>
            <Link href="/about" className={`font-medium hover:text-[#008CFF] text-md ${pathname === "/about" ? "text-[#008CFF]" : "text-gray-800"}`}>We Are</Link>
            <Link href="/" className={`font-medium hover:text-[#008CFF] text-md ${pathname === "/" ? "text-[#008CFF]" : "text-gray-800"}`}>Career</Link>
          </div>
