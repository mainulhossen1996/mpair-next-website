...
const Solution = () => {
  return (
    ...
    <div className='max-w-screen-xl mx-auto py-36'>
        ...
        <div className="flex flex-col lg:flex-row justify-center  gap-10 pt-20">
        ...
        <div className="card-back-bg border border-gray-800 rounded-xl flex flex-col justify-center p-6 pt-10 mt-10">
