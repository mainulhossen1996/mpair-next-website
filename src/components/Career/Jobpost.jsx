  ...
  return (
    <div className="max-w-screen-xl mx-auto mt-22 p-6">
      ...
      <div className="flex flex-col gap-5">
        {filteredCards[activeCategory]?.map((jobs) => (
          <div key={jobs?.id} className=" p-4 ">
            <div className="flex flex-row justify-between items-start">
              ...
              <Link href={`/career/${jobs.id}`}>
                <button className="justify-end mt-8 px-4 py-2 text-sm font-semibold text-white bg-blue-500 rounded-full hover:bg-blue-600">
                  Apply Now
                  <FontAwesomeIcon
                    icon={faArrowUp}
