...
const ApplyForm =() => {
 ...
 return (
    <div className="max-w-3xl mx-auto bg-gray-100 p-10 rounded-sm my-10 ">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="items-center justify-center flex">
          <button type="submit" className=" w-[170px] rounded-full bg-blue-500 text-white py-2 px-3 hover:bg-blue-600 transition duration-200"> Submit Now<FontAwesomeIcon icon={faArrowUp} className="ml-2 rotate-45" style={{color: "#ffffff"}} />
        </button>
        </div>
      </form>
    </div>
