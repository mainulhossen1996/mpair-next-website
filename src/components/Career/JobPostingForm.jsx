  ...
  return (
    <div className=" flex justify-center max-w-2xl mx-auto mb-20 p-6 mt-[180px]">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <label htmlFor="jobDescription" className="block font-medium mb-1"> Job Description <span className="text-red-500">*</span>
          </label>
          <textarea
            name="jobDescription"
...
{/* Experience */}
<div>
          <label htmlFor="experience" className="block font-medium mb-1">Experience Required <span className="text-red-500">*</span></label>
          <input
            type="text"
            name="experience"
        ...
        {/* Salary */}
        <div>
          <label htmlFor="salary" className="block font-medium mb-1">Salary <span className="text-red-500">*</span></label>
          <input
            type="text"
            name="salary"
        ...
        {/* Location */}
        <div>
          <label htmlFor="Location" className="block font-medium mb-1">Location <span className="text-red-500">*</span></label>
          <input
            type="text"
            name="Location"
        ...
        {/* Skills */}
        <div>
          <label htmlFor="skills" className="block font-medium mb-1">Required Skills <span className="text-red-500">*</span></label>
          <input
            type="text"
            name="skills"
        ...
        {/* Status */}
        <div>
          <label htmlFor="status" className="block font-medium mb-1">Job Status <span className="text-red-500">*</span></label>
          <select
            name="status"
            onChange={handleChange}
            className="w-full p-2 border rounded"
