  ...
  return (
    <div className="export-box py-6 rounded-3xl px-4">
      ...
      src= {serviceImg}
                height={350}
                width={130}
                className="lg:h-[80px] h-[70px] lg:px-[20px] px-0 object-contain justify-start"/>
        <p className="px-[20px] lg:text-[30px] text-[18px] text-gray-800 font-semibold lg:mt-0 mt-4 mb-3">Marketing & Growth Strategy</p>
