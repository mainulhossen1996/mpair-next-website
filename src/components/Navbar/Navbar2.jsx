...
const Navbar2 = () => {
  ...
  const Servicetabs = [
    ...
    },
    {
      ...
      description: "Build responsive, modern, and high-performing websites.",
      image: "/image/ui-nav.png",
      url: "/service/cloud-software",
    },
    {
      id: "tab4",
      title: "Robotics & IoT",
  ...
  const Producttabs = [
    {
      ...
      title: "SchoolSys",
      description:
        "A solution that integrates various administrative and academic processes within an educational institution.",
      image: "/image/product/schoolsys.png",
    },
    {
      id: "tab2",
      title: "Emventory",
      description: "Build responsive, modern, and high-performing websites.",
      image: "/image/product/emventory.png",
    },
    {
      id: "tab3",
      title: "Someekoron",
      description: "Creating robust and user-friendly mobile applications.",
      image: "/image/product/someekoron.png",
    },
    {
      id: "tab4",
      title: "DocAppoint",
      description: "Strategies to boost your online presence and engagement.",
      image: "/image/product/docAppoint.png",
    },
  ];
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (
        dropdownRefPro.current &&
        !dropdownRefPro.current.contains(event.target)
      ) {
  ...
  return (
    <>
      <div className="absolute lg:top-3 left-0 right-0 z-50">
        ...
        >
          <Link href="/home" className="">
            <img
              className="lg:h-[30px] h-[24px] w-auto object-contain"
              src="/image/Logo-White.svg"
              alt="mPair Technologies"
              height={300}
              width={300}
            />
          </Link>
          ...
          <div className="hidden md:flex gap-10 items-center">
            <Link
              ...
              className={`font-medium flex items-center ${
                pathname === "/contact-us" ? "text-white" : "text-white"
              }`}
            >
      ...
      <div
        className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 p-5 px-10 transition-all duration-300 lg:block hidden
        ...
        <div className="flex gap-12 center-item">
          <div className="relative" ref={dropdownRef}>
            <div
              ...
              className="font-medium cursor-pointer text-[14px]  hover:text-[#008CFF] flex gap-2 items-center"
              ...
              <div className="absolute left-0 top-12 mt-2 bg-[#f9f9f9] border border-gray-200 rounded-lg p-4 h-[330px] w-[45vw]">
                <div className="flex gap-4 w-full mx-auto mt-10">
                    ...
                    {Servicetabs.map((tab) => (
                      <Link key={tab.id} href={tab.url}>
                        <p
                          ...
                          onMouseEnter={() =>
                            handleTabChange("service", tab.id)
                          }
                  ...
                  <div
                    ...
                    style={{
                      borderImage:
                        "linear-gradient(to bottom, transparent, #565656, transparent) 1",
                  ...
                  >
                    {Servicetabs.map(
                      (tab) =>
                        activeTab.service === tab.id && (
                          <div key={tab.id}>
                            <p className="text-gray-700 text-end text-sm">
                              {tab.description}
                            </p>
                            <div className="flex justify-end">
                              <Image
                                ...
                                width={400}
                                height={400}
                                className="mt-4 h-[180px] object-contain"
                              />
                            </div>
                          </div>
                        )
                      ...
                      (tab) =>
                        activeTab.product === tab.id && (
                          <div key={tab.id} className="mt-10">
                            ...
                            <p className="text-gray-700 mt-4 text-end text-sm">
                              {tab.description}
                            </p>
                          </div>
                        )
