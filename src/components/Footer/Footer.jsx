        ...
        <div className="text-center">
          <div className="grid lg:grid-cols-4 sm:grid-cols-1 gap-20 mb-4 border-b-1 pb-4 lg:px-[0px] sm:px-[30px]">
            <div className="text-start">
              <p className="font-regular text-lg text-gray-600 mb-4">Contact</p>
            ...
            <div className="text-center">
              ...
              <p className="font-light text-sm text-gray-600 mb-2">Marketing</p>
              <p className="font-light text-sm text-gray-600 mb-2">
                Robotics & IoT
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="font-light text-sm text-gray-600 mb-2">SchoolSys</p>
              <p className="font-light text-sm text-gray-600 mb-2">emventory</p>
              <p className="font-light text-sm text-gray-600 mb-2">
                Someekoron
              </p>
              <p className="font-light text-sm text-gray-600 mb-2">
            ...
            <div className="text-center">
              <p className="font-regular text-lg text-gray-600 mb-4">Company</p>

              <p className="font-light text-sm text-gray-600 mb-2">About Us</p>
              <p className="font-light text-sm text-gray-600 mb-2">Clients</p>
              <p className="font-light text-sm text-gray-600 mb-2">Career</p>
              <p className="font-light text-sm text-gray-600 mb-2">
                Articles & Events
              </p>
