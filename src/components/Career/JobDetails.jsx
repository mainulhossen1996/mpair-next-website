      ...
      <div className="flex flex-col gap-10 justify-center items-center mx-auto pl-16 mt-[120px]">
        ...
        <div className=" ">
          ...
          <ul className="mt-4 space-y-1 text-sm text-gray-600 list-disc pl-5">
            ...
            <li>
              {" "}
              <span className="font-medium text-lg">Salary:</span> {job.salary}
            </li>
            <li>
              {" "}
            ...
            <li>
              {" "}
              <span className="font-medium text-lg">Status:</span> {job.status}
            </li>
          </ul>
        </div>
        <div>
          <Link href={`/career/apply`}>
            <button className="justify-end mt-8 px-6 py-3 text-sm font-semibold text-white bg-blue-500 rounded-full hover:bg-blue-600">
              Apply Now
              <FontAwesomeIcon
                icon={faArrowUp}
