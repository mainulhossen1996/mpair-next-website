...
import TextBox from '../Articles/Textbox';
      ...
      <div className="flex flex-col gap-5">
        {filteredCards[activeCategory]?.map((jobs, index) => (
          <div key={index} className=" p-4 ">
            ...
            <button className="flex justify-end items-center mt-8 px-6 py-2 text-sm font-medium text-white bg-blue-500 rounded-full hover:bg-blue-400">Apply Now                
