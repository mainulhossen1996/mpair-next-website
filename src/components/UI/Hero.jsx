...
const Hero = () => {
  ...
  return (
    <div className="ui-hero-bg pt-32">
      <section className="max-w-screen-xl mx-auto" id="Hero">
        <div className="">
          <div className="text-center lg:py-16 py-0">
            <p className="text-[90px] font-semibold mb-2 text-white">
             UI/UX <span className="font-thin font-tinos-italic">Design Partner</span> <br/><span className="font-thin text-gray-300">For Your Startup, Brand</span>
            </p>
        ...
        <div className="border-t border-b border-gray-800 mt-10 ">
            <div className="flex justify-between ">
            <div className="border-e border-gray-800 w-3/12 py-6 px-4 h-[210px]">
            ...
            />
            <div className="">
                <p className="text-lg font-semibold">Muntasir Hasan</p>
                <p className="text-sm text-gray-400">UI Design Head, mPair</p>
            </div>
            </div>
            <p className="pt-0 leading-[22px] font-thin text-sm">
